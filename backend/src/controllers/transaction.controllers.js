...
exports.getTransactions = async (req, res) => {
    try {
        ...
        const month = req.query.month ? monthMap[req.query.month]: 3;
...
// get api to fetch the data from all the 3 APIs mentioned above, combines the response and sends a final response of the combined JSON
